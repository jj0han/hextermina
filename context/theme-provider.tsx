...
// Custom hook for animated theme toggle functionality
export const useThemeToggle = ({
  ...
  // Match ThemeProvider defaultTheme="dark" while resolvedTheme is undefined (SSR/hydration)
  const resolvedIsDark =
    resolvedTheme === undefined ? true : resolvedTheme === "dark"

  // Optimistic override for instant icon feedback during view transitions
  const [pendingIsDark, setPendingIsDark] = useState<boolean | null>(null)
  const isDark = pendingIsDark ?? resolvedIsDark
